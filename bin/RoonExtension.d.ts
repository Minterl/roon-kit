import { RoonApi, RoonCore, RoonSubscriptionResponse, RoonExtensionDescription, ProvidedRoonServices, RoonApiTransportOutputs, RoonApiTransportZones, WSConnectOptions } from './interfaces';
...
export declare class RoonExtension extends EventEmitter {
     ...
     * @param provided_services Optional. Additional services provided by extension. RoonApiState is already provided so DO NOT add this service.
     */
    ws_connect(options: WSConnectOptions, provided_services?: ProvidedRoonServices[]): void;
    /**
